...
export default function DiscoverPage() {
  ...
  return (
    <div className="app-layout flex w-full min-h-screen bg-background relative">
      {/* Sidebar Navigation */}
      <div className="w-64 min-w-64 max-w-64 bg-sidebar border-r border-sidebar-border flex flex-col fixed left-0 top-0 bottom-0 h-screen flex-shrink-0 z-20 overflow-x-hidden">
        <ChatSidebar
          sessions={[]}
        ...
        <section className="pb-12 pt-4">
          ...
          {!isLoading && centers.length === 0 && !locationError ? (
            ...
            <CenterList 
               ...
               onClickToggle={handleCardSingleClick}
               onDoubleClickToggle={handleCardDoubleClick}
               isLoading={isLoading}
            />
          )}
        </section>
